...
class CoachTermsConditions extends StatelessWidget {
  const CoachTermsConditions({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: FutureBuilder(
          future: ProfileTabService().coachCms(),
                ...
                return Padding(
                  ...
                  child: Column(
                    children: data
                        .map(
                          (e) => Html(
                            data: e.data[0].coachTermsConditions!,
                            onLinkTap:
